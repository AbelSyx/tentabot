...
def callback(data):
    ...
    noisy_q = tf.transformations.quaternion_from_euler(0, 0, pose[2])
    noisy_odom.pose.pose.orientation.x = noisy_q[0]
    noisy_odom.pose.pose.orientation.y = noisy_q[1]
    noisy_odom.pose.pose.orientation.z = noisy_q[2]
    noisy_odom.pose.pose.orientation.w = noisy_q[3]
    noisy_odom.twist = data.twist
...
if __name__ == '__main__':
    ...
    if rospy.has_param("~new_odom_frame"):
        ...
        new_odom_topic = "/turtlebot3_0/odom_noise"
